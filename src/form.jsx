        ...
        <div style={styles.sideComponent}>
          ...
          <div style={styles.sideContent}>
            ...
            <p style={styles.welcomeText}>
              Welcome to nucleusFUSION! This form helps you connect with mentors if you require tips on cracking an interview. Please enter the following details:
            </p>
          </div>
        </div>
        <div style={styles.formContainer}>
          {step === 1 ? (
            <form onSubmit={handleSubmit} style={styles.form}>
              ...
              <div style={styles.formGroup}>
                <label style={styles.label}>The organization you are interviewing for. You may specify additional details if you like:</label>
                <input
                  name="company"
